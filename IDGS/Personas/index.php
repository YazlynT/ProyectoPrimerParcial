...
<div class="modal fade" id ="ModalNuevo">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header"> <h4 class="modal-tittle">Personas | Nuevo Registro</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ap_materno " id="ap_materno" class="form-control" placeholder="ApMaterno">
                                </div>
                            </div>  
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="apPaterno">Curp:</label>
   ...
   if(nombre == ""||ap_paterno== ""||ap_materno ==""||sexo == ""||curp ==""){
    Swal.fire({
  position: "top-end",
  icon: "warning",
...
$.ajax({
  ...
  position: "top-end",
  icon: "success",
  title: "Registro de Personas Guardado",
  showConfirmButton: false,
  timer: 2000
});
  ...
  position: "top-end",
  icon: "success",
  title: "Registro de Personas Eliminado ",
  showConfirmButton: false,
  timer: 2000
}).then(() =>{
        var table= $("#lista_personas").dataTable().api();
